    ...
    def run_test(self):
        ...
        with open('sim_results.txt', 'a+') as res:
                ...
                for line in f:
                    if ops % 500 == 0:
                        if ops > 0:
                            ...
                            csinfo = tester.coinselectioninfo()
                            ...
                            result_str = "| {} | {:.8f} | {:.2f} | {} | {} | {} | {} | {:.8f} | {:.8f} | {:.8f} | {:.8f} | {:.8f} | {:.8f} | {:.8f} | {:.8f} | {:.8f} | {} | {} | {:.8f} | {:.8f} | {} | {} | {} |".format( \
                                ...
                                cost_to_empty, total_cost, min_input_size, max_input_size, mean_input_size, stdev_input_size, csinfo['BnB_Usage'], csinfo['SRD_Usage'], csinfo['Knapsack_Usage'])
                            res.write('{}\n'.format(result_str))
            ...
            self.log.info("| Simulation File | final value | mean #UTXO | final #UTXO | #received | #spent | #payments sent |"
                ...
                + "min input set | max input set | mean size of input set | stdev of input set size | BnB Usage | SRD Usage | Knapsack Usage")
